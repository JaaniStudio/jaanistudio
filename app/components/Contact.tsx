              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid gap-5 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      type="text"
                      required
                      className="w-full rounded-lg border border-[#8FA1AD]/20 bg-[#1B262E] px-4 py-3 text-[#F3ECE0] outline-none transition-colors focus:border-[#FFA649]"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    required
                    className="w-full resize-none rounded-lg border border-[#8FA1AD]/20 bg-[#1B262E] px-4 py-3 text-[#F3ECE0] outline-none transition-colors focus:border-[#FFA649]"
                ...
                <button
                  type="submit"
                  className="w-full rounded-lg bg-[#FFA649] py-3.5 text-sm font-semibold text-[#1B262E] transition-transform hover:scale-[1.01] active:scale-[0.99]"
                >
                  Send brief
                </button>
              </form>
