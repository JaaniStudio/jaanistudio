...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-[#1B262E] px-6 py-24 md:py-32" ref={sectionRef}>
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -left-32 -top-32 h-96 w-96 rounded-full opacity-60" style={{ background: 'radial-gradient(circle, rgba(255,166,73,0.45) 0%, transparent 70%)', filter: 'blur(35px)' }} />
        <div className="absolute -right-32 -bottom-32 h-80 w-80 rounded-full opacity-50" style={{ background: 'radial-gradient(circle, rgba(143,161,173,0.35) 0%, transparent 70%)', filter: 'blur(30px)' }} />
      </div>
