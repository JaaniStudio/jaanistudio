...
export default function Portfolio() {
  ...
  const headerRef = useScrollReveal<HTMLElement>(['.portfolio-header', '.portfolio-heading', '.portfolio-filters']);
  ...
  return (
    <section id="work" className="relative bg-[#283845] py-24 md:py-32" ref={headerRef}>
      <div className="mx-auto max-w-6xl px-6">
        <div className="portfolio-header mb-14 flex items-center gap-4 font-[family-name:var(--font-mono)] text-xs uppercase tracking-widest text-[#FFA649]">
          <span>00:03</span>
        ...
        <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-end">
          <h2 className="portfolio-heading max-w-lg font-[family-name:var(--font-display)] text-3xl leading-tight text-[#F3ECE0] sm:text-4xl md:text-5xl">
            Sites people visit. Reels people rewatch.
          </h2>

          <div className="portfolio-filters flex gap-2">
            {FILTERS.map((f) => (
              <button
                key={f.value}
          ...
          >
            {filtered.map((project) => (
              <a
                ...
                href="#contact"
                onClick={onCardClick}
                className="group relative aspect-[4/3] w-[78vw] shrink-0 snap-start overflow-hidden rounded-xl border border-[#FFA649]/10 transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-2 hover:border-[#FFA649]/30 hover:shadow-[0_20px_50px_-16px_rgba(255,166,73,0.25)] sm:w-[42vw] md:w-[30vw] lg:w-[26vw]"
              >
                {project.type === 'web' ? (
                  ...
                  >
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="flex h-14 w-14 items-center justify-center rounded-full bg-[#1B262E]/70 backdrop-blur transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover:scale-110 group-hover:bg-[#FFA649]/20 group-hover:shadow-[0_0_30px_rgba(255,166,73,0.3)]">
                        <Play className="ml-0.5 h-5 w-5 fill-[#FFA649] text-[#FFA649] transition-transform duration-300 group-hover:scale-110" />
                      </span>
                    </div>
                  </div>
                )}
                ...
                <div className="pointer-events-none absolute inset-0 flex flex-col justify-between p-6">
                  ...
                  <div>
                    <h3 className="flex items-center gap-1.5 font-[family-name:var(--font-display)] text-xl font-semibold text-[#F3ECE0] transition-all duration-300 group-hover:translate-x-1">
                      {project.name}
                      {project.type === 'web' && (
        ...
        <div className="mx-auto mt-6 flex max-w-6xl items-center justify-between px-6">
          <div className="flex gap-2">
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-[#FFA649]/20 text-[#F3ECE0] transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:scale-110 hover:border-[#FFA649] hover:text-[#FFA649] hover:shadow-[0_0_20px_rgba(255,166,73,0.15)] disabled:pointer-events-none disabled:opacity-25"
            >
